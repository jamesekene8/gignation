    ...
    public partial class changeddatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobApplicants", x => new { x.AppUserId, x.JobId });
                    table.ForeignKey(
                        name: "FK_JobApplicants_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_JobApplicants_CoverLetters_CoverLetterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobApplicants_CoverLetterId",
                table: "JobApplicants",
